    ...
    def post(self, request):
        try:
            ...
            access_token = requests.post(
                f"https://github.com/login/oauth/access_token?code={code}&client_id=e81f8485025e328aaeea&client_secret={settings.GH_SECRET}",
...
class KakaoLogIn(APIView):
    def post(self, request):
        try:
            ...
            access__token = access_token.json().get("access_token")
            user_data = requests.get(
                "https://kapi.kakao.com/v2/user/me",
                headers={
                    "Authorization": f"Bearer {access__token}",
